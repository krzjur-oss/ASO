# Regulamin i Polityka Prywatności aplikacji „Akademia Systemów Operacyjnych”

**Wersja 1.0.0 · obowiązuje od 16 lipca 2026 r.**

---

## § 1. Postanowienia ogólne

1. Niniejszy Regulamin określa zasady korzystania z aplikacji **„Akademia Systemów Operacyjnych”** (dalej: „Aplikacja”), dostępnej pod adresem strony.
...
2. Dane wprowadzane do Aplikacji (np. imię ucznia, zdobyte punkty XP, stan ukończenia misji i quizu) przechowywane są **wyłącznie lokalnie w pamięci przeglądarki użytkownika** (`localStorage`) i nigdy nie opuszczają jego urządzenia.
...
4. Aplikacja nie używa plików cookie, narzędzi analitycznych ani reklamowych systemów śledzenia.
5. Użytkownik może w każdej chwili usunąć swoje dane, czyszcząc dane przeglądarki lub korzystając z przycisku resetu postępu w stopce.
